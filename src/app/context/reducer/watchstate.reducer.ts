...
export const watchstateActions = {
  CHANGE_STEPS: "STEPS",
  CHANGE_STEPS_GOAL: "STEPS_GOAL",
  CHANGE_BATTERY: "CHANGE_BATTERY",
  CHANGE_CALORIES: "CHANGE_CALORIES",
  CHANGE_HEARTRATE: "CHANGE_HEARTRATE",
  CHANGE_DISTANCE: "CHANGE_DISTANCE",
  CHANGE_PAI: "CHANGE_PAI",
  CHANGE_DATE: "DATE",
  CHANGE_TIME: "TIME",
  CHANGE_SUNRISE_HOURS: "CHANGE_SUNRISE_HOURS",
  CHANGE_SUNRISE_MIN: "CHANGE_SUNRISE_MIN",
  CHANGE_SUNSET_HOURS: "CHANGE_SUNSET_HOURS",
  CHANGE_SUNSET_MIN: "CHANGE_SUNSET_MIN",
  CHANGE_WEATHER_ICON: "CHANGE_WEATHER_ICON",
  CHANGE_TEMP: "CHANGE_TEMP",
  CHANGE_TEMP_MIN: "CHANGE_TEMP_MIN",
  CHANGE_TEMP_MAX: "CHANGE_TEMP_MAX",
  CHANGE_AIR_QUALITY: "CHANGE_AIR_QUALITY",
